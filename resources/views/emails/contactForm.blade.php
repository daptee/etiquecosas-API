...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Nuevo formulario de contacto desde la web</div>
  <div role="article" aria-roledescription="email" aria-label="Formulario de contacto" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding: 48px; text-align: left; font-size: 16px; line-height: 26px; color: #444;">
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 16px; font-size: 20px; font-weight: 600; color: #347AA7;">
                        Nuevo formulario de contacto
                      </p>

                      <p style="margin: 0 0 24px 0;">
                        Hola! Te avisamos que han enviado un nuevo formulario de contacto desde la web, con los siguientes datos:
                      </p>

                      <table style="width: 100%; border-collapse: collapse; margin: 24px 0;" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; font-weight: 600; width: 140px; vertical-align: top;">Nombre:</td>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; vertical-align: top;">{{ $nombre }}</td>
                        </tr>
                        <tr>
                          ...
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; vertical-align: top;">
                            <a href="mailto:{{ $email }}" style="color: #347AA7; text-decoration: none;">{{ $email }}</a>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; font-weight: 600; vertical-align: top;">Telefono:</td>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; vertical-align: top;">{{ $telefono }}</td>
                        </tr>
                        <tr>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; font-weight: 600; vertical-align: top;">Motivo:</td>
                          <td style="padding: 12px 0; border-bottom: 1px solid #eee; vertical-align: top;">{{ $motivo }}</td>
                        </tr>
                        <tr>
                          <td style="padding: 12px 0; font-weight: 600; vertical-align: top;">Comentarios:</td>
                          <td style="padding: 12px 0; vertical-align: top;">{{ $comentarios }}</td>
                        </tr>
                      </table>

                      <p style="margin: 32px 0 0 0;">&nbsp;</p>
                      <p style="margin: 0;">Muchas gracias.</p>
                      <p style="margin: 8px 0 0 0; font-weight: 600; color: #347AA7;">El equipo IT de Etiquecosas.</p>
                    </td>
                  </tr>
                </table>
              </td>
