...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Nueva consulta de producto</div>
  <div role="article" aria-roledescription="email" aria-label="Consulta de producto" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding: 48px; text-align: left; font-size: 16px; line-height: 26px; color: #444;">
                      ...
                      <p style="font-size: 20px; font-weight: 600; margin-bottom: 8px;">Hola 👋</p>
                      <p style="font-size: 17px; color: #333;">
                        Te avisamos que <strong>{{ $nombre }} {{ $apellido }}</strong> ha consultado el precio del producto:
                        <strong>{{ $nombreProducto }}</strong>, por una cantidad de <strong>{{ $cantidad }}</strong>.
                      </p>

                      <p style="margin-top: 20px;">Ha dejado los siguientes datos:</p>
                      <ul style="padding-left: 20px; margin: 12px 0 24px; color: #555; font-size: 15px;">
                        <li><strong>Email:</strong> {{ $email }}</li>
                        <li><strong>Teléfono:</strong> {{ $telefono ?: 'No informado' }}</li>
                        <li><strong>Mensaje:</strong> {{ $texto ?: 'Sin mensaje' }}</li>
                      </ul>

                      <div style="text-align: center; margin-top: 32px;">
                        <p style="margin: 0 0 24px 0; font-size: 16px;">
                          Muchas gracias.<br>
                          <strong>El equipo de Etiquecosas 💛</strong>
                        </p>
                      </div>
