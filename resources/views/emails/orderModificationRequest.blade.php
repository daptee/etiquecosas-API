...
<head>
  ...
  <title>Solicitud de modificación de pedido</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Solicitud de modificación de pedido</div>
  <div role="article" aria-roledescription="email" aria-label="Modificación de pedido" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
