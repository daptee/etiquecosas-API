              ...
              <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                    ...
                    <p style="font-size:18px; font-weight:600; margin-bottom:16px;">¡Dejaste algo en tu carrito! 🛒</p>
                    <p style="margin: 0 0 16px 0;">Vimos que empezaste una compra y no llegaste a terminarla. Te la dejamos guardada por si querés retomarla.</p>
