                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                      ...
                      <p style="margin-top:16px; font-size:16px; color:#444;">Tu pedido <strong>#{{ $sale->id }}</strong> sigue en producción, pero <strong>¡cada vez falta menos para que esté listo y llegue a tus manos!</strong> ✨</p>

                      <p style="margin:16px 0; font-size:16px; color:#444;">Cuando esté terminado y preparado para enviar o retirar, te vamos a avisar por este medio.</p>
