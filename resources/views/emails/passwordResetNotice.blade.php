...
<head>
  ...
  <title>Tu contraseña fue restablecida</title>
...
<body style="margin:0; width:100%; padding:0; word-break:break-word; -webkit-font-smoothing:antialiased; background-color:#ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule:exactly; display:none;">Por un problema técnico restablecimos tu contraseña</div>
  <div role="article" aria-roledescription="email" aria-label="Tu contraseña fue restablecida" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule:exactly;">
                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                      <h2 style="color:#2c3e50; margin-bottom:20px;">Tu contraseña fue restablecida</h2>

                      <p style="font-size:15px; color:#333;">Hola <strong>{{ $name }}</strong>,</p>

                      <p style="font-size:15px; color:#333;">Tuvimos un problema técnico en nuestro sistema y, por precaución, tuvimos que restablecer tu contraseña. Vos no tenés que hacer nada más que ingresar con la que te dejamos acá abajo:</p>

                      <p style="margin-top:16px; font-size:16px; font-weight:600; color:#EBA4AB;"><strong>{{ $password }}</strong></p>

                      <p style="font-size:15px; color:#333; margin-top:16px;">Por favor, entrá a tu cuenta y cambiala por una nueva apenas puedas.</p>
                      ...
                      <p style="font-size:15px; color:#333; margin-top:32px;">Cualquier duda o problema para ingresar, escribinos y te ayudamos.</p>

                      <p style="font-size:15px; color:#333; margin-top:16px;">Gracias por tu paciencia,</p>
                      <p style="font-size:15px; color:#333;">El equipo de <strong>Etiquecosas</strong></p>
                    </td>
                  </tr>
                </table>
              </td>
