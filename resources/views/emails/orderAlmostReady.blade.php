...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #ECEFF1;">
  <div role="article" aria-roledescription="email" aria-label="Pedido casi listo" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                      ...
                      <p style="margin-top:16px; font-size:18px; font-weight:600;">Tu pedido <span style="color:#EBA4AB;">#{{ $sale->id }}</span> ya está casi listo ✨</p>

                      <p style="margin-top:16px; font-size:14px; color:#444;">Queríamos avisarte que tuvimos una pequeña demora porque algunos de los productos no salieron bien impresos/troquelados y preferimos reimprimirlos para asegurarnos de que lleguen perfectos a tus manos.</p>

                      <p style="margin-top:16px; font-size:14px; color:#444;">Te pedimos disculpas por este contratiempo y quedate tranquilo/a que ya le estamos dando prioridad.</p>

                      <p style="margin-top:16px; font-size:14px; color:#444;"><strong>Ni bien esté listo para enviar o retirar, te avisamos por este medio.</strong></p>

                      <div style="text-align:center; margin-top:32px;">
                        <p style="margin:0 0 24px 0; font-size:16px;">💛 <strong>Gracias por tu paciencia y por confiar en Etiquecosas</strong></p>
                      </div>
