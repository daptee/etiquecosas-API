...
<head>
  ...
  <title>Tu pedido sigue en producción</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Tu pedido sigue en producción</div>
  <div role="article" aria-roledescription="email" aria-label="Tu pedido sigue en producción" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                      ...
                      <p style="margin-top:16px; font-size:18px; font-weight:600;">Tu pedido sigue en producción 🛠️</p>
                      ...
                      <div style="margin:16px 0; padding:15px; background:#f9f9f9; border-left:4px solid #EBA4AB;">
                        ...
                        <p style="margin:0; font-size:14px; color:#555;">✨ <strong>Estado:</strong> En producción</p>
                        <p style="margin:0; font-size:14px; color:#555;">🕒 <strong>Próximo paso:</strong> Te avisaremos cuando esté listo para enviar o retirar.</p>
                      </div>

                      <p style="margin:16px 0; font-size:14px; color:#444;">Estamos trabajando con mucho cariño en tus productos 💛. ¡Cada vez falta menos para que estén listos!</p>
