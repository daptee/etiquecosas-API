...
<body style="margin:0; width:100%; padding:0; word-break:break-word; -webkit-font-smoothing:antialiased; background-color:#ECEFF1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule:exactly; display:none;">Recuperar Contraseña</div>
  <div role="article" aria-roledescription="email" aria-label="Recuperar Contraseña" lang="es" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule:exactly;">
                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="padding:48px; text-align:left; font-size:16px; line-height:26px; color:#444;">
                      <h2 style="color:#2c3e50; margin-bottom:20px;">Recuperar Contraseña</h2>

                      <p style="font-size:15px; color:#333;">Hola <strong>{{ $name }}</strong>,</p>

                      <p style="font-size:15px; color:#333;">Hemos recibido la solicitud para restablecerte la contraseña. Te dejamos a continuación tu nueva contraseña para que puedas acceder a la plataforma:</p>

                      <p style="margin-top:16px; font-size:16px; font-weight:600; color:#EBA4AB;"><strong>{{ $password }}</strong></p>

                      <p style="font-size:15px; color:#333; margin-top:16px;">No olvides cambiarla cuando ingreses.</p>

                      <p style="font-size:15px; color:#333; margin-top:16px;">Muchas gracias,</p>
                      <p style="font-size:15px; color:#333;">El equipo IT de <strong>Etiquecosas</strong></p>
                    </td>
                  </tr>
                </table>
              </td>
