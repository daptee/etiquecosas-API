    ...
    <div class="transfer-container" style="{{ $plantilla['isWhite'] ? 'background-color: #CACACA;' : '' }}">
      ...
      <div class="tranfer-names-container">
        <div class="transfer-name-container">
          <p class="name name-border" style="color: cmyk({{ $plantilla['color'][0] }}); font-size: {{ $plantilla['fontSize'] }}">{!! formatName($product_order->name, 2, 10, $product_order->firstName ?? null) !!}</p>
        </div>
        <div class="transfer-name-container">
